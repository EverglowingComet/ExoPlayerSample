 ...
 * extractors for them to the constructor. Otherwise, pass a {@link CustomExtractorsFactory} to
 ...
 */
public final class CustomExtractorMediaSource implements MediaSource, CustomExtractorMediaPeriod.Listener {
    /**
     * Listener of {@link CustomExtractorMediaSource} events.
     *
    ...
    /** Factory for {@link CustomExtractorMediaSource}s. */
    public static final class Factory implements AdsMediaSource.MediaSourceFactory {
        ...
        /**
         * Creates a new factory for {@link CustomExtractorMediaSource}s.
         *
         ...
         * instance of {@link CustomExtractorsFactory}.
         *
         ...
         */
        public CustomExtractorMediaSource.Factory setExtractorsFactory(ExtractorsFactory extractorsFactory) {
         ...
         * @throws IllegalStateException If one of the {@code create} methods has already been called.
         */
        public CustomExtractorMediaSource.Factory setCustomCacheKey(String customCacheKey) {
            Assertions.checkState(!isCreateCalled);
         ...
         * @throws IllegalStateException If one of the {@code create} methods has already been called.
         */
        public CustomExtractorMediaSource.Factory setMinLoadableRetryCount(int minLoadableRetryCount) {
            Assertions.checkState(!isCreateCalled);
         ...
         * @throws IllegalStateException If one of the {@code create} methods has already been called.
         */
        public CustomExtractorMediaSource.Factory setContinueLoadingCheckIntervalBytes(int continueLoadingCheckIntervalBytes) {
            Assertions.checkState(!isCreateCalled);
        ...
        /**
         * Returns a new {@link CustomExtractorMediaSource} using the current parameters. Media source events
         * will not be delivered.
         *
         * @param uri The {@link Uri}.
         * @return The new {@link CustomExtractorMediaSource}.
         */
        public CustomExtractorMediaSource createMediaSource(Uri uri) {
            return createMediaSource(uri, null, null);
        }

        /**
         * Returns a new {@link CustomExtractorMediaSource} using the current parameters.
         *
         * @param uri The {@link Uri}.
         ...
         */
        @Override
        public CustomExtractorMediaSource createMediaSource(
                Uri uri, @Nullable Handler eventHandler, @Nullable MediaSourceEventListener eventListener) {
            isCreateCalled = true;
            if (extractorsFactory == null) {
                extractorsFactory = new CustomExtractorsFactory();
            }
            return new CustomExtractorMediaSource(uri, dataSourceFactory, extractorsFactory,
     ...
     *     Otherwise, pass a {@link CustomExtractorsFactory} to use default extractors.
     * @param eventHandler A handler for events. May be null if delivery of events is not required.
     * @param eventListener A listener of events. May be null if delivery of events is not required.
     * @deprecated Use {@link CustomExtractorMediaSource.Factory} instead.
     */
    @Deprecated
    public CustomExtractorMediaSource(
            Uri uri,
            DataSource.Factory dataSourceFactory,
            ExtractorsFactory extractorsFactory,
            Handler eventHandler,
            CustomExtractorMediaSource.EventListener eventListener) {
    ...
    public CustomExtractorMediaSource(
        ...
        this(
                ...
                eventHandler,
                eventListener == null ? null : new CustomExtractorMediaSource.EventListenerWrapper(eventListener),
                customCacheKey,
                continueLoadingCheckIntervalBytes);
    }

    private CustomExtractorMediaSource(
            Uri uri,
            DataSource.Factory dataSourceFactory,
            ExtractorsFactory extractorsFactory,
            int minLoadableRetryCount,
    ...
    public MediaPeriod createPeriod(MediaPeriodId id, Allocator allocator) {
        ...
        return new CustomExtractorMediaPeriod(
                uri,
    ...
    public void releasePeriod(MediaPeriod mediaPeriod) {
        ((CustomExtractorMediaPeriod) mediaPeriod).release();
    }
    ...
    // CustomExtractorMediaPeriod.Listener implementation.
    ...
    /**
     * Wraps a deprecated {@link CustomExtractorMediaSource.EventListener}, invoking its callback from the equivalent callback in
     * {@link MediaSourceEventListener}.
     */
    private static final class EventListenerWrapper implements MediaSourceEventListener {
        private final CustomExtractorMediaSource.EventListener eventListener;

        public EventListenerWrapper(CustomExtractorMediaSource.EventListener eventListener) {
