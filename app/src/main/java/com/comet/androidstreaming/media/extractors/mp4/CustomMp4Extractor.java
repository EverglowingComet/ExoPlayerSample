 ...
 */
public final class CustomMp4Extractor implements Extractor, SeekMap {

    /**
     * Factory for {@link CustomMp4Extractor} instances.
     */
    public static final ExtractorsFactory FACTORY = new ExtractorsFactory() {

        @Override
        public Extractor[] createExtractors() {
            return new Extractor[] {new CustomMp4Extractor()};
        }
    ...
    private final @CustomMp4Extractor.Flags
    int flags;
    ...
    private CustomMp4Extractor.Mp4Track[] tracks;
     ...
     */
    public CustomMp4Extractor(@CustomMp4Extractor.Flags int flags) {
        this.flags = flags;
    ...
    private void processMoovAtom(Atom.ContainerAtom moov) throws ParserException {
        ...
        List<CustomMp4Extractor.Mp4Track> tracks = new ArrayList<>();
        ...
        for (int i = 0; i < moov.containerChildren.size(); i++) {
            ...
            CustomMp4Extractor.Mp4Track mp4Track = new CustomMp4Extractor.Mp4Track(track, trackSampleTable,
        ...
        this.tracks = tracks.toArray(new CustomMp4Extractor.Mp4Track[tracks.size()]);
    ...
    private int readSample(ExtractorInput input, PositionHolder positionHolder)
        ...
        CustomMp4Extractor.Mp4Track track = tracks[sampleTrackIndex];
    ...
    private int getTrackIndexOfNextReadSample(long inputPosition) {
        ...
        for (int trackIndex = 0; trackIndex < tracks.length; trackIndex++) {
            CustomMp4Extractor.Mp4Track track = tracks[trackIndex];
            int sampleIndex = track.sampleIndex;
    ...
    private void updateSampleIndices(long timeUs) {
        for (CustomMp4Extractor.Mp4Track track : tracks) {
     ...
     */
    private static long[][] calculateAccumulatedSampleSizes(CustomMp4Extractor.Mp4Track[] tracks) {
